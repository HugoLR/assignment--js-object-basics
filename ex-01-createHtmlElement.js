...
function createHtmlElement(object) {
  var primerPropiedad = object.element;
  var segunaPropiedad = object.classNames;
  var tercerPropiedad = object.textContent;

  var htmlString = '<'+ primerPropiedad + ' class="'  + segunaPropiedad + '">' + tercerPropiedad + '</' + primerPropiedad + '>';
  return htmlString
}
